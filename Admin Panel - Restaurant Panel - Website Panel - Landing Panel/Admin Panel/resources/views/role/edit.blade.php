                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="deliveryman" value="deliveryman"
                                                            name="deliveryman[]" class="permission" {{ in_array('deliveryman', $permissions) ? 'checked' : '' }}>
                                                        <label class="control-label2"
                                                            for="deliveryman">{{ trans('lang.list') }}</label>
                                                        <input type="checkbox" id="deliveryman-create"
                                                            value="deliveryman.create" name="deliveryman[]" class="permission" {{ in_array('deliveryman.create', $permissions) ? 'checked' : '' }}>
                                                        <label class="control-label2"
                                                            for="deliveryman-create">{{ trans('lang.create') }}</label>
                                                        <input type="checkbox" id="deliveryman-edit" value="deliveryman.edit"
                                                            name="deliveryman[]" class="permission" {{ in_array('deliveryman.edit', $permissions) ? 'checked' : '' }}>
                                                        <label class="control-label2"
                                                            for="deliveryman-edit">{{ trans('lang.edit') }}</label>
                                                        <input type="checkbox" id="deliveryman-delete"
                                                            value="deliveryman.delete" name="deliveryman[]" class="permission" {{ in_array('deliveryman.delete', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="advertisements" value="advertisements"
                                                            name="advertisements[]" class="permission"  {{ in_array('advertisements', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2"
                                                            for="advertisements">{{ trans('lang.list') }}</label>
                                                        <input type="checkbox" id="advertisements-create"
                                                            value="advertisements.create" name="advertisements[]" class="permission"  {{ in_array('advertisements.create', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2"
                                                            for="advertisements-create">{{ trans('lang.create') }}</label>
                                                        <input type="checkbox" id="advertisements-edit" value="advertisements.edit"
                                                            name="advertisements[]" class="permission"  {{ in_array('advertisements.edit', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2"
                                                            for="advertisements-edit">{{ trans('lang.edit') }}</label>
                                                        <input type="checkbox" id="advertisements-view" value="advertisements.view"
                                                            name="advertisements[]" class="permission"  {{ in_array('advertisements.view', $permissions) ? 'checked' : '' }}>
                                                        <label class="control-label2"
                                                            for="advertisements-view">{{ trans('lang.view') }}</label>
                                                        <input type="checkbox" id="advertisements-delete"
                                                            value="advertisements.delete" name="advertisements[]" class="permission"  {{ in_array('advertisements.delete', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="advertisements-listrequest" value="advertisements.request"
                                                            name="advertisements-list[]" class="permission" {{ in_array('advertisements.request', $permissions) ? 'checked' : '' }}>
                                                        <label class="control-label2"
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="scheduleOrderNotification"
                                                            ...
                                                            class="permission" {{ in_array('settings.app.scheduleOrderNotification', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2"
