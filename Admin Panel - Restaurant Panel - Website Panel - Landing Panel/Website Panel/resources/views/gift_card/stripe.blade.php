                ...
                <div>
                    <div class="siddhi-cart-item mb-3 rounded shadow-sm bg-white overflow-hidden">
                        <div class="siddhi-cart-item-profile bg-white p-3">
                                        ...
                                        <td class="text-right payment-buttons">
                                            <form action="<?php echo route('process-stripe'); ?>" method="post">
                                                ...
                                                <input type="hidden" name="address_zipcode" id="address_zipcode"
                                                       value="<?php echo $gift_cart_order['address_zipcode']; ?>">
                                                <div class="form-group row">
                            ...
                            <button type="submit" class="btn btn-primary">{{ trans('lang.pay') }} {{ $formatted_price }}</button>
                            <div class="outcome">
...
<script type="text/javascript">
    ...
    function setOutcome(result) {
        ...
        if (result.token) {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo route('giftcard.stripepayment'); ?>",
                data: {
                ...
                success: function (data) {
                    ...
                    if (data.status == true) {
                        ...
                        window.location.href = '<?php echo route('giftcard.success'); ?>';
                    } else {
