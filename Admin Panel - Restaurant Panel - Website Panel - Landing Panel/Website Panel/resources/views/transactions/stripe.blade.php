                                ...
                                <table class="payment-table">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right payment-buttons">
                                            ...
                                            <form action="<?php echo route('wallet-process-stripe'); ?>" method="post">
                                                ...
                                                <div class="form-group row">
                                                    <label
                                                        class="col-sm-3 col-form-label">{{trans('lang.country')}}</label>
                                                    <div class="col-sm-6">
                                                ...
                                                <div class="form-group row">
                                                    <label
                                                        class="col-sm-3 col-form-label">{{trans('lang.state')}}</label>
                                                    <div class="col-sm-6">
                                                ...
                                                <div class="form-group row">
                                                    <label
                                                        class="col-sm-3 col-form-label">{{trans('lang.city')}}</label>
                                                    <div class="col-sm-6">
                                                ...
                                                <div class="form-group row">
                                                    <label
                                                        class="col-sm-2 col-form-label">{{trans('lang.card')}}</label>
                                                    <div class="col-sm-9">
    ...
    function setOutcome(result) {
        ...
        if (result.token) {
            ...
            $.ajax({
                ...
                url: "<?php echo route('wallet-process-stripe'); ?>",
