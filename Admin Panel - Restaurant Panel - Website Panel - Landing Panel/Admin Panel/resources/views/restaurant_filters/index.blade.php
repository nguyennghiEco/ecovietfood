...
function buildHTML(snapshots){
    ...
    alldata.forEach((listval) => {
        var val=listval;
            ...
            html=html+'<td class="action-btn"><a href="'+route1+'"><i class="mdi mdi-lead-pencil" title="Edit"></i></a><a id="'+val.id+'" name="restaurant-filter-delete" href="javascript:void(0)"><i class="mdi mdi-delete"></i></a></td>';
            html=html+'</tr>';
            count =count +1;
        });
        return html;      
