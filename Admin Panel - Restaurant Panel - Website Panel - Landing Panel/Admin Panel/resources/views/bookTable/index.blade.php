                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table-responsive m-t-10">
                                <table id="bookTable" class="display nowrap table table-hover table-striped table-bordered table table-striped" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
